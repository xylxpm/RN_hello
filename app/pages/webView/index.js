...
import {
    View, Text, TextInput, TouchableOpacity, WebView,StyleSheet
} from 'react-native';
            ...
            <View style={styles.rnArea}>
                ...
                <View>
                    <TouchableOpacity style={styles.button}
                                      onPress={this.handleSet}><Text>Send To Web</Text></TouchableOpacity>
                    <TouchableOpacity style={styles.button}
                                      onPress={this.handleGet}><Text>Get From Web</Text></TouchableOpacity>
                </View>
            </View>
        )
    }
